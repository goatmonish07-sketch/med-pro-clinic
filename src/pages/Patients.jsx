...
import { PageHead, Kpi, Card, Segmented, Table, Avatar, StatusBadge } from '../components/ui'
import { patients, patientStats, patientFilters, avatarGradients } from '../data/mock'
...
export default function Patients() {
  ...
  return (
    <>
      <PageHead title="Patients" sub="2,481 total · 320 new this month · 18 active today">
      ...
      <Card
        title="All patients"
        action={<Segmented options={patientFilters} value={filter} onChange={setFilter} />}
      >
            ...
            >
              <td className="px-[15px] py-[11px]">
                <div className="flex items-center gap-2.5">
                  <Avatar initials={p.initials} gradient={avatarGradients[p.initials]} />
        ...
        <div className="flex items-center justify-between px-[15px] py-[11px] text-[11.5px] text-ink-3">
          <span>Showing {rows.length} of 2,481</span>
